...
namespace Wyam.Commands
{
    ...
    internal abstract class Command
    {
        ...
        public void Parse(System.CommandLine.ArgumentSyntax syntax, Preprocessor preprocessor)
        {
            // Global options
            if (GlobalArguments)
            {
        ...
        protected virtual void ParseOptions(System.CommandLine.ArgumentSyntax syntax)
        {
        }

        protected virtual void ParseParameters(System.CommandLine.ArgumentSyntax syntax)
        {
        }
        ...
        protected static void ParseRootPathParameter(System.CommandLine.ArgumentSyntax syntax, ConfigOptions configOptions)
        {
