...
namespace NAnt.NUnit1.Tasks {
    ...
    public class NUnitTask : Task {
        ...
        // TODO implement launching in a separate App Domain
...
#else
            RemoteNUnitTestRunner runner = (RemoteNUnitTestRunner)Activator.CreateInstance(
                typeof(RemoteNUnitTestRunner), 
                bindingAttr: 0, 
                binder: null,
